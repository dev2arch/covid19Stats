  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function HomeComponent(covidDataService) {
        ...
        this.stats = [];
        this.statesChart = {
          'states': [['Maharashtra', 74, 'red', 74], ['Kerala', 64, 'red', 64], ['Delhi', 26, 'red', 26], ['Uttar Pradesh', 27, 'red', 27], ['Rajasthan', 26, 'red', 26], ['Karnataka', 22, 'red', 22], ['Telangana', 22, 'red', 22], ['Haryana', 22, 'red', 22], ['Punjab', 21, 'Orange', 21], ['Gujarat', 18, 'red', 18], ['Ladakh', 13, 'orange', 13], ['Chandigarh', 8, 'orange', 8], ['[West Bengal', 7, 'yellow', 7], ['Tamil Nadu', 6, '', 6], ['Andhra Pradesh', 5, 'darkyellow', 5], ['J&K', 4, 'darkyellow', 4], ['Madhya Pradesh', 4, 'yellow', 4], ['Uttarakhand', 3, 'green', 3], ['Odisha', 2, 'darkgreen', 2], ['Himachal Pradesh', 2, 'darkgreen', 2], ['BIHAR', 2, 'darkgreen', 2], ['Oddisha', 2, 'darkgreen', 2], ['Puducherry', 1, 'darkgreen', 1], ['Chhattisgarh', 1, 'darkgreen', 1], ['Assam', 1, 'darkgreen', 1]],
          'type': 'BarChart',
