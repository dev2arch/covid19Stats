  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function HomeComponent(covidDataService) {
        ...
        this.stats = [];
        this.statesChart = {
          'states': [['Maharashtra', 72, 'red', 72], ['Kerala', 52, 'red', 52], ['Delhi', 26, 'red', 26], ['Uttar Pradesh', 26, 'red', 26], ['Rajasthan', 23, 'red', 23], ['Telangana', 21, 'red', 21], ['Karnataka', 19, 'red', 19], ['Haryana', 18, 'red', 18], ['Gujarat', 14, 'red', 14], ['Ladakh', 13, 'orange', 13], ['Punjab', 13, 'Orange', 13], ['Tamil Nadu', 6, '', 6], ['Andhra Pradesh', 5, 'darkyellow', 5], ['Chandigarh', 5, 'darkyellow', 5], ['J&K', 4, 'darkyellow', 4], ['[West Bengal', 4, 'yellow', 4], ['Madhya Pradesh', 4, 'yellow', 4], ['Uttarakhand', 3, 'green', 3], ['Odisha', 2, 'darkgreen', 2], ['Himachal Pradesh', 2, 'darkgreen', 2], ['Puducherry', 1, 'darkgreen', 1], ['Chhattisgarh', 1, 'darkgreen', 1], ['Assam', 1, 'darkgreen', 1]],
          'type': 'BarChart',
