...
class HomeComponent {
    ...
    getStatesSegrigatedData() {
        this.covidDataService.getStatesData().subscribe(data => { this.statesChart.states = data['statesArrayData'], this.dataSource['data'] = data['mapdata'], console.log(data); }, (err) => console.log(err));
    }
}
...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], hostBindings: function HomeComponent_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 79, vars: 19, consts: [["role", "main", 1, "content", "conent-padding"], [2, "background", "#fff"], [1, "card", "highlight-card", "card-small", "app-padding", 2, "justify-content", "left"], ["mat-icon-button", "", "matTooltip", "Language", 1, "pl-4", 3, "click"], [1, "text-primary"], [1, "langSelect", 3, "value", "valueChange", "selectionChange"], ["select", ""], [3, "value", 4, "ngFor", "ngForOf"], [1, "pl-4", "text-primary"], [1, "card-container", "row", "no-margin"], ["tabindex", "0", 1, "card", "card-small", "app-padding", "col-12", "col-md-3"], [2, "color", "#32a3ff"], [1, "pl-1"], [2, "color", "#ff7b1c"], [2, "color", "#901c21"], [2, "color", "#ff666d"], [2, "color", "#47cd57"], [2, "color", "#ffd835"], ["tabindex", "0", 1, "card", "card-small", "app-padding", "col-12", "col-md-12", "mb-0", 2, "border-bottom", "none"], [2, "color", "#6e6e6e"], [1, "col-md-12", "border", "text-center"], ["height", "550", "type", "india", 3, "width", "dataSource"], ["tabindex", "0", 1, "col-md-12", "border", 2, "border-top", "0"], [3, "title", "type", "data", "columnNames", "options", "width"], ["chart", ""], [1, "pl-1", "text-primary"], ["routerLink", "/centers"], [1, "pl-2"], [3, "value"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
